...
class BrevoEmailService {
  ...
  async sendOTPEmail(user, otp) {
    ...
    const payload = {
      ...
      subject,
      htmlContent: html,
      textContent: `Your AWIB SACCO authentication code is: ${otp}. This code will expire in 10 minutes. If you didn't request this code, please secure your account immediately.`
    };
